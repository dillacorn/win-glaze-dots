...
Assert-Contains $config "on_right: 'exec explorer.exe shell:AppsFolder\40459File-New-Project.EarTrumpet_1sdd7yawvg6ne!EarTrumpet'" "volume right click directly activates EarTrumpet without a WGDot helper"
Assert-NotContains $config "shell:AppsFolder\\40459File-New-Project.EarTrumpet_1sdd7yawvg6ne!EarTrumpet" "retired doubled-backslash EarTrumpet AppsFolder target stays absent"
