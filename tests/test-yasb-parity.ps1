...
Assert-Contains $config 'theme_group:' "bar exposes a native YASB theme drawer"
Assert-Contains $config 'theme_choices:' "theme drawer has direct native YASB choices"
Assert-Contains $config 'widgets: ["theme_choices"]' "theme drawer groups only the direct theme choices"
Assert-Contains $config 'launch: "wgdot theme carbon-night"' "theme drawer exposes Carbon Night directly"
Assert-Contains $config 'launch: "wgdot theme catppuccin-frappe"' "theme drawer exposes Catppuccin Frappe directly"
Assert-Contains $config 'launch: "wgdot theme crimson-red"' "theme drawer exposes Crimson Red directly"
Assert-Contains $config 'launch: "wgdot theme electric-blue"' "theme drawer exposes Electric Blue directly"
Assert-Contains $config 'launch: "wgdot theme gruvbox"' "theme drawer exposes Gruvbox directly"
Assert-Contains $config 'launch: "wgdot theme iron-forge"' "theme drawer exposes Iron Forge directly"
Assert-Contains $config 'launch: "wgdot theme obsidian-night"' "theme drawer exposes Obsidian Night directly"
Assert-Contains $config 'launch: "wgdot theme pink"' "theme drawer exposes Pink directly"
Assert-Contains $config 'launch: "wgdot theme pipboy"' "theme drawer exposes Pip-Boy directly"
Assert-NotContains $config 'exec wt.exe -w new wgdot theme' "bar theme clicks no longer open a terminal selector"
...
Assert-Contains $style '.theme-grouper' "theme drawer has dedicated flat styling"
Assert-Contains $style '.theme-choice-buttons' "direct theme choices have compact styling"
...
Assert-Contains $readme 'visual preview cards' "theme-drawer limitation versus Awtarchy is documented"
