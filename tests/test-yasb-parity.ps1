...
Assert-Contains $config 'binding_modes_to_cycle_through: ["none", "noalt", "vm"]' "YASB cycles the restored noalt and VM modes"
...
foreach ($glaze in @($glazeNormal, $glazeWork)) {
    ...
    Assert-NotContains $glaze 'bindings: ["alt+ctrl+b"]' "legacy hard-hide hotkey is removed"
