...
Assert-True ($altSnapConfigText -match '(?m)^AutoFocus=1\r?
Assert-True ($altSnapConfigText -match '(?m)^Hotkeys=A4 A5 5B 5C\r?
...
Write-Host "WGDot tests passed." -ForegroundColor Green
) "AltSnap focuses windows while dragging by default"
Assert-True ($altSnapConfigText -match '(?m)^Hotkeys=A4 A5 5B 5C$') "AltSnap enables left/right Alt and Win modifier keys by default"
...
Write-Host "WGDot tests passed." -ForegroundColor Green
) "AltSnap enables left/right Alt and Win modifier keys by default"
