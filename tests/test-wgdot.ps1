...
Assert-True ($yaziBookmarksText -match 'local ROOT = "wgdot-bookmarks://collection/@/"') "Yazi bookmarks expose a valid hub VFS collection root"
...
Assert-True ($yaziRecentText -match 'local ROOT = "wgdot-recents://collection/@/"') "Yazi recents expose a valid hub VFS collection root"
