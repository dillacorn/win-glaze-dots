...
Assert-True ($nativeSourceText -match 'const string Version = "native-preview-37"') "native runtime version tracks direct-command refresh and official GitHub packages"
