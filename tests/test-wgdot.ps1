...
Assert-True ($nativeSourceText -match 'const string Version = "native-preview-48"') "native runtime version tracks startup, WinGet, and GPU maintenance changes"
...
Write-Host "WGDot tests passed." -ForegroundColor Green
) "Flameshot defaults to capturing the active monitor without monitor selection"
