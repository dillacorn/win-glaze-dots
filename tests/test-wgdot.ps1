...
Assert-True ($yaziInitText -match 'WgdotYaziContextMenu:show\("item", event\.x, event\.y\)') "Yazi item right-click opens item actions"
...
Assert-True ($yaziInitText -match 'Keys: Enter open \| O open with \| r rename') "Yazi item context footer teaches keyboard equivalents"
Assert-True ($yaziInitText -match 'Keys: a create \| p paste \| t e terminal') "Yazi blank-space context footer teaches keyboard equivalents"
