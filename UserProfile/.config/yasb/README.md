...
| legacy bar visibility hotkey | removed: `Alt+Ctrl+B` is no longer allowed to hard-hide YASB because it can strand an invisible bar while GlazeWM still reserves spaceing/restarting YASB | YASB CLI `toggle-bar` + managed GlazeWM binding |
